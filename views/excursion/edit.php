...
<form class="form-style w-50 h-100 mx-auto p-3 my-3" action="" method="post">
    ...
    <div class="row g-3 align-items-center mb-2">
        <div class="col-2">
            <label for="inputPassword6" class="col-form-label">Гід:</label>
        </div>
        <div class="col-5">
            <input type="checkbox" id="inputPassword6" name="gid" <?if($excursion["IsWithGuide"]==1) echo "checked"?>>
        </div>
        <div class="col-auto">
    <span  class="form-text text-danger">
    ...
    <div class="row g-3 align-items-center mb-2">
        <div class="col-2">
            <label for="inputPassword6" class="col-form-label">Ціна:</label>
        </div>
        <div class="col-5">
